...
CREATE TABLE `users_meta_info` (
  ...
  `created_at` text COLLATE utf8mb4_unicode_ci DEFAULT 'current_timestamp()',
  `updated_at` text COLLATE utf8mb4_unicode_ci DEFAULT 'current_timestamp()',
  `deleted_at` text COLLATE utf8mb4_unicode_ci DEFAULT 'current_timestamp()',
